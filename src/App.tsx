...
import { Check, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, CircleStop, Code2, FileCode2, Folder, FolderOpen, GitBranch, LoaderCircle, Maximize2, MessageSquare, Minimize2, Play, Plus, Save, ScrollText, Settings2, TerminalSquare, WandSparkles, X } from "lucide-react";
...
const terminalThemes = {
  maestr: { background: "#242423", foreground: "#e8eddf", cursor: "#f5cb5c", selectionBackground: "#4c4e48" },
...
const defineMonacoThemes: BeforeMount = (monaco) => {
  const themes: Record<string, { background: string; foreground: string; accent: string }> = { maestr: { background: "242423", foreground: "e8eddf", accent: "f5cb5c" }, onedark: { background: "282c34", foreground: "abb2bf", accent: "61afef" }, catppuccin: { background: "181825", foreground: "cdd6f4", accent: "cba6f7" }, nord: { background: "2e3440", foreground: "d8dee9", accent: "88c0d0" }, solarized: { background: "002b36", foreground: "839496", accent: "b58900" } };
